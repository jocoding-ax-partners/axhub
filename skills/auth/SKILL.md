---
name: auth
description: This skill should be used when the user asks about login, logout, token state, or current identity. Activates on "로그인해", "로그인해줘", "다시 로그인", "토큰 만료됐어", "토큰 갱신해줘", "인증 다시", "권한이 없대", "scope 없대", "누구로 접속하는 거야", "누구야", "어떤 계정이야", "토큰 살아있어", "로그인 됐어", "로그인 상태", "로그아웃해", "토큰 지워줘", "로그인해주세요", "다시 로그인해주세요", "로그인 상태 알려주세요", "어떤 계정으로 접속 중인가요", "login", "log in", "sign in", "logout", "log out", "sign out", "who am I", "whoami", "auth", "authenticate", "scope", "token expired", "refresh token", or any axhub identity-management request. Detects headless environments and switches to token-paste flow when no browser is available.
---
