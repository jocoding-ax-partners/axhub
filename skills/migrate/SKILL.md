...
- `planner` 서브 에이전트 1회 실행 → `.axhub/plan/runs/<run_id>/stages/02-planner.md` + meta 저장
- `architect` 서브 에이전트 실행 → `.axhub/plan/runs/<run_id>/stages/03-architect.md` + meta 저장
- `critic` 서브 에이전트 실행 → `.axhub/plan/runs/<run_id>/stages/04-critic.md` + meta 저장
- `reviewer` 서브 에이전트 실행 → `.axhub/plan/runs/<run_id>/stages/05-reviewer.md` + meta 저장
