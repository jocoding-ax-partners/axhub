---
name: apis
description: This skill should be used when the user wants to discover available axhub API endpoints. Activates on "API 뭐 있어", "어떤 API 있어", "API 목록 봐", "API 리스트", "API 카탈로그", "쓸 수 있는 API", "호출 가능한 API", "엔드포인트 뭐 있어", "API 보여줘", "사내 API 뭐 있어", "API 목록 보여주세요", "사용 가능한 API 알려주세요", "API 카탈로그 확인해주세요", "어떤 엔드포인트가 있나요", "apis", "list apis", "api catalog", "available apis", "available endpoints", "endpoints", "services", or any axhub API discovery request. Defaults to the current app scope and asks before crossing team boundaries.
---
