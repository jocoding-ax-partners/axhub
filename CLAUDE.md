...
- frontmatter validity check — 6 skill 의 SKILL.md frontmatter 유효성.
...
이 repo 의 공개 plugin surface 는 `onboarding` / `init` / `deploy` / `development` / `clarity` / `update` 여섯 스킬이에요.
