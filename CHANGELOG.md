...
* **relay:** 웹훅 창구에 스테이징 주소 추가 (spec 606) ([7a9b505](https://github.com/jocoding-ax-partners/axhub-mono/commit/7a9b5053ecccb9f7e6528587afde77dbd1065581))


### Fixed

* **plugin:** push 직후 완료된 배포도 정확히 추적 ([#412](https://github.com/jocoding-ax-partners/axhub-mono/issues/412)) ([70ab564](https://github.com/jocoding-ax-partners/axhub-mono/commit/70ab564189235203b121ca7acee67e4aac32442a))


### Docs

* 브랜치 규칙에 앱 접두사 — Spec Kit 번호 오염을 막는다 ([2d7e4fe](https://github.com/jocoding-ax-partners/axhub-mono/commit/2d7e4fe927113be214bf097cc948baff0f4d1f06))
...
* **deploy,bootstrap:** 저장소 없는 앱은 기본 배포 경로로, 폴백 알림에 재연결 안내 ([#441](https://github.com/jocoding-ax-partners/axhub/issues/441)) ([4434326](https://github.com/jocoding-ax-partners/axhub/commit/4434326c5279a1b5f8c5d99957a1efafcf9f4958)), closes [#439](https://github.com/jocoding-ax-partners/axhub/issues/439) [#439](https://github.com/jocoding-ax-partners/axhub/issues/439)
...
* device flow 재시도 코드 재노출과 배포 대기 수단 우선 규칙 917d79a, closes #519
...
* UserPromptSubmit 라우터 prompt-field 매칭 + auto-update 훅 보강 ([#383](https://github.com/jocoding-ax-partners/axhub/pull/383))
...
* update skill 이 dry-run 안내에 머물지 않고 실제 `axhub update apply --execute --yes` 흐름을 안내하도록 정리
* deploy/onboarding skill 의 배포 검증을 app-scoped `axhub deploy verify <deployment-id> --app <app>` 계약에 정합
* import/development skill 을 최신 CLI manifest, static access note, SDK surface 안내와 맞춰 보강
