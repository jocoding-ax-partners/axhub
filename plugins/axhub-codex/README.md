...
**상태**: 10 SKILL (onboarding · bootstrap · scaffold · publishing · deploy · import · development · diagnosis · clarity · update) · ax-hub-cli 직접 호출 (코어 v0.20.0+ · 기존 8스킬 v0.21.3+ · scaffold v0.30.0+ · publishing은 `axhub plugin publish` 기능 게이트) · Codex CLI ≥ 0.147.0 (최종 검증: 0.149.0)
...
- 승인 채널이 없는 headless(`codex exec`·CI)에서는 실행하지 않고 멈춰요.
