...
**상태**: v0.5.2 (ship). 19 SKILLs / 10 commands / 5 cross-arch cosign-signed binaries 라이브.
...
- v0.5.2 에서도 plugin helper 를 Rust native binary 하나로 유지해요.
