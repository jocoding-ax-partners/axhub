...
🚀 배포
  /axhub:deploy [앱이름] [--commit <sha>] [--dry-run]
  /axhub:배포 [앱이름] [--commit <sha>] [--dry-run]  # 한글 alias
  자연어 예시: "paydrop 배포해", "방금 푸시한 거 올려"

📊 상태 확인
  /axhub:status
  자연어 예시: "지금 진행 중인 거 어떻게 됐어"

📝 로그 보기
  /axhub:logs
  자연어 예시: "왜 실패했어, 빌드 로그 보여줘"

📦 앱 목록
  /axhub:apps
  자연어 예시: "내 앱 목록", "어떤 앱 있어"

🔑 로그인
  /axhub:login
  자연어 예시: "로그인해", "권한 만료된 것 같아"

🔧 진단 (axhub 설치 확인 등)
  /axhub:doctor
  자연어 예시: "axhub 설치돼 있어?", "환경 점검"
